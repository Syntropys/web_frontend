    ...
    >
      <div className="space-y-5">
        ...
        <div className="rounded-xl border border-[#C9A24B]/20 bg-[#C9A24B]/5 px-4 py-3 flex items-start gap-2.5">
          <Info size={14} className="text-[#8C6E26] dark:text-[#C9A24B] mt-0.5 shrink-0" />
