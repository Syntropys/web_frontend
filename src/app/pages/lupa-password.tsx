        ...
        <div className="space-y-4">
          <div className="flex items-start gap-3 p-4 rounded-xl border border-[#C9A24B]/30 bg-[#C9A24B]/12 dark:bg-[#C9A24B]/15 text-[#5F6A64] dark:text-[#B8BFB9]">
            <CheckCircle2
              size={18}
              strokeWidth={1.6}
              className="text-[#735A1E] dark:text-[#C9A24B] shrink-0 mt-0.5"
            />
          ...
          <button
            ...
            className="w-full inline-flex items-center justify-center px-5 py-2.5 rounded-full border border-[#2A3530]/15 dark:border-[#E8E6DF]/15 text-[#5F6A64] dark:text-[#B8BFB9] text-[13px] tracking-wide hover:border-[#C9A24B] hover:text-[#735A1E] dark:hover:text-[#C9A24B] transition-colors cursor-pointer"
          >
            Kirim ulang tautan
          </button>
        </div>
