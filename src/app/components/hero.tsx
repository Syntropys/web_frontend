...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 px-5 sm:px-8 lg:px-14 pt-28 sm:pt-36 lg:pt-44 pb-14 sm:pb-24 flex flex-col min-h-[88svh] lg:min-h-screen justify-center">
        <div className="max-w-4xl">
          ...
          <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row sm:flex-wrap sm:items-center gap-3 sm:gap-4">
            ...
            <Link
              to="/daftar"
              className="inline-flex items-center justify-center gap-3 px-6 sm:px-7 py-3.5 sm:py-4 rounded-full border border-[#E8E6DF]/20 text-[#E8E6DF] text-[13px] sm:text-[14px] tracking-wide hover:border-[#E8E6DF]/40 hover:bg-white/5 transition-colors cursor-pointer"
            >
              Daftar Sekarang
            </Link>
          </div>
