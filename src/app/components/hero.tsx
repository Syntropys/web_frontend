...
export function Hero() {
  ...
  return (
    <section
      id="beranda"
      className="relative min-h-screen w-full overflow-hidden bg-[#0B1215]"
    >
      ...
      <div className="relative z-10 px-5 sm:px-8 lg:px-14 pt-16 sm:pt-20 lg:pt-36 pb-14 sm:pb-24 flex flex-col min-h-screen justify-center lg:justify-start">
        <div className="max-w-4xl">
          ...
          <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row sm:flex-wrap sm:items-center gap-3 sm:gap-4">
            ...
            <Link
              to="/daftar"
              className="inline-flex items-center justify-center gap-3 px-6 sm:px-7 py-3.5 sm:py-4 rounded-full border border-[#E8E6DF]/20 text-[#E8E6DF] hover:border-[#E8E6DF]/40 hover:bg-white/5 transition-colors cursor-pointer text-[13px] sm:text-[14px] tracking-wide"
            >
              Daftar Sekarang
            </Link>
          </div>
