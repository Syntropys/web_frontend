  ...
  return (
    <label className="block">
      ...
      <div className="relative">
        {icon && (
          <span className={`pointer-events-none absolute inset-y-0 left-3 flex items-center ${hasError ? "text-[#B85C5C] dark:text-[#D17878]" : "text-[#5F6A64] dark:text-[#A8AFA9]"}`}>
            {icon}
          </span>
        )}
        <input
      ...
      {hasError ? (
        ...
        <span className="block mt-1.5 text-[11px] text-[#5F6A64] dark:text-[#A8AFA9]">
          {hint}
        </span>
      ) : null}
    </label>
...
function GoogleIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 48 48" aria-hidden="true">
      <path fill="#FFC107" d="M43.6 20.5H42V20H24v8h11.3c-1.6 4.7-6.1 8-11.3 8a12 12 0 110-24c3 0 5.8 1.1 7.9 3l5.7-5.7A20 20 0 1024 44c11 0 20-9 20-20 0-1.2-.1-2.4-.4-3.5z" />
      <path fill="#FF3D00" d="M6.3 14.7l6.6 4.8C14.6 16 19 13 24 13c3 0 5.8 1.1 7.9 3l5.7-5.7A20 20 0 006.3 14.7z" />
      <path fill="#4CAF50" d="M24 44c5.2 0 10-2 13.6-5.2l-6.3-5.3a12 12 0 01-18-6.1l-6.6 5.1A20 20 0 0024 44z" />
      <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3a12 12 0 01-4 5.5l6.3 5.3C41.4 35.7 44 30.3 44 24c0-1.2-.1-2.4-.4-3.5z" />
    </svg>
  );
}
